                ...
                <header className="bg-white h-16 shadow-sm flex items-center justify-end px-8 sticky top-0 z-10">
                    <div className="flex items-center gap-6">
                        <div className="relative cursor-pointer group">
                            <div className="p-2 bg-slate-50 rounded-full text-gray-400 group-hover:text-purple-600 group-hover:bg-purple-50 transition-all">
                                <Bell size={20} />
                            </div>
                        ...
                        <div className="flex items-center gap-4 border-l pl-6 border-gray-100">
                            ...
                            <div className="h-10 w-10 bg-purple-600 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-purple-100 ring-2 ring-white">
